package com.amasugfu.vton.view.google
...
const val kNearPlane = 0.05f     // 5 cm
const val kFarPlane = 1000.0f    // 1 km
...
open class ModelViewer(
    ...
    protected var fetchResourcesJob: Job? = null

    protected var swapChain: SwapChain? = null
    protected var assetLoader: AssetLoader
    protected var materialProvider: MaterialProvider
    protected var resourceLoader: ResourceLoader
    protected val readyRenderables = IntArray(128) // add up to 128 entities at a time

    protected val eyePos = DoubleArray(3)
    protected val target = DoubleArray(3)
    protected val upward = DoubleArray(3)
    ...
    protected fun populateScene(asset: FilamentAsset) {
    ...
    protected fun addDetachListener(view: android.view.View) {
    ...
    protected suspend fun fetchResources(asset: FilamentAsset, callback: (String) -> Buffer) {
    ...
    protected fun updateCameraProjection() {
    ...
    protected fun synchronizePendingFrames(engine: Engine) {
    ...
    companion object {
        protected val kDefaultObjectPosition = Float3(0.0f, 0.0f, -4.0f)
    }
}